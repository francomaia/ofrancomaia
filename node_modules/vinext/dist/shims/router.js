...
function resolveLocalRedirectUrl(location) {
	...
	if (appPath === null) return null;
	if (appPath.startsWith("//")) return normalizePathTrailingSlash(location, __trailingSlash);
